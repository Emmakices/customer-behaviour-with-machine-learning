...
fbeta = metrics.fbeta_score(y_test, y_pred, average='weighted', beta=0.5)

# Create a bar chart
metrics_names = ['Accuracy', 'Precision', 'Recall', 'F-beta']
metrics_values = [accuracy, precision, recall, fbeta]
